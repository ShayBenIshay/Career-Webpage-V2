export const projectsData = [
  {
    ...
    description:
      "A platform that allows users to manage their portfolio, set future buy/sell orders, and analyze their portfolio.",
    features:
  ...
  },
  {
    ...
    description:
      "An AI agent that manages a portfolio, sets future buy/sell orders, and analyzes the portfolio.",
    features:
